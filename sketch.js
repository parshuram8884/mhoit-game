...
var asteroidImg,spaceshipImg, blastImg;
var bullet,bulletImg;
var asteroidsGroup,bulletsGroup,spaceshipGroup;
var gameState=1;
var score=0 ;
...
function handleBubbleCollision(asteroidsGroup){
     ...
     blast= createSprite(asteroid.x,asteroid.y, 50,50);
...
function handleGameover(asteroidsGroup){
  ...
  blast= createSprite(spaceship.x,spaceship.y+6, 50,50);
  blast.addImage(blastImg) 
